...
function GirlsNewbornCard({ id, img, name, desc, price }) {
    ...
    <div className="max-w-xs bg-white rounded-2xl shadow-lg overflow-hidden m-4 hover:shadow-2xl transition">
      ...
      <div className="p-4 flex flex-col">
        ...
        <button
          ...
          className="mt-auto w-full bg-gray-400 text-white py-2 rounded-lg hover:bg-green-300 transition"
        >
          Add to Cart
        </button>
      </div>
...
export default GirlsNewbornCard
